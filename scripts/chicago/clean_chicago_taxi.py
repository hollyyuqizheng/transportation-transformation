...
data = pd.read_csv("C:\\Users\\CodeB\\Documents\\GitHub\\transportation-transformation\\data\\chicago\\chicago_taxi_2000_rows.csv")
...
with open("chi_taxi_daily_ridership_descriptive_stats.json", "w") as fout:
